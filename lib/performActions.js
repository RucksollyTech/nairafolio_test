...
// export const myClassConverterRevised = (mode,data)=>{
//     const allClasses = data.split(" ")
//     let darkModeClasses = ""
//     let lightModeClasses = ""
//     for (let i = 0; i < allClasses.length; i++) {
//         const element = allClasses[i];
//         if(element.includes("dark:")){
//             const specificClass = element.split("dark:")
//             darkModeClasses = `${darkModeClasses} ${specificClass[1]}`
//         }else{
//             lightModeClasses = `${lightModeClasses} ${element}`
//         }
//     }
//     if(mode === "dark"){
